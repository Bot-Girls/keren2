...
cl = LINETCR.LINE()
cl.login(token="EnVnHqePgGxZtI0srfJ8.mo/iIpXMm/2U/v+MJgHSsa.+5St21ewfvdlse2m6AtHga3YizWWYbdz1VQkMk5jPic=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="Enb0KZnrf51r5GJxE3c0.hIvl/2gfxP6SsXSqGjs2aa.XDAhtc/iheYkB83w4LYRMGt5DxFlis6ql9dGvK3Unjw=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="En8IZvqMl5mgzuN1E5Ne.DNcjB3AgaMigrbmdeISphG.wKZrK127Nv+ShvZXJJbFknBTUfkx4RgL4zOaJmR1kqw=")
ki2.loginResult()
...
owner =["u30ef8888fc6633edaef95fe68c686c48"]
...
def bot(op):
            ...
            if op.param2 not in Bots:
              if op.param2 in Bots:
                ...
                try:
                  ...
                  cl.sendText(op.param1, "Mau Invite Siapa Pak ??? \nJangan Sok Jadi Jagoan Deh Lu Njir.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
                except:
                  random.choice(KAC).cancelGroupInvitation(op.param1, gMembMids)
                  random.choice(KAC).sendText(op.param1, "Mau Invite Siapa Pak ??? \nJangan Sok Jadi Jagoan Deh Lu Njir.\nAdmin Bukan,Owner Juga Bukan\Kick Ah 😛")
                  random.choice(KAC).kickoutFromGroup(op.param1,[op.param2])
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin sεℓғвσт вү-sρεcιαℓ αηιмε||\n=====================\n"
                  for mi_d in admin:
        ...
        #-----------------------------------------
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"sεℓғвσт вү-sρεcιαℓ αηιмε Mau Bersih² Group Sampah Nih")
                    cl.sendText(msg.to,"Karna Ini Group Sampah Jadi Mau Di Bersihin Dulu Yah\n★Jangan Baper...\n★Jangan Nangis\n★Jangan Cengeng\nBawa Enjoy Aja Kawan♪")
                    msg.contentType = 13
                    msg.contentMetadata = {'mid': 'u30ef8888fc6633edaef95fe68c686c48'}
                    cl.sendMessage(msg)
    ...
    for zx in range(0,200):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐sεℓғвσт вү-sρεcιαℓ αηιмε⭐👈\n\n™By https://line.me/R/ti/p/%40kyx3655e")
          ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐sεℓғвσт вү-sρεcιαℓ αηιмε⭐👈\n\n™By https://line.me/R/ti/p/%40kyx3655e")
          ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐sεℓғвσт вү-sρεcιαℓ αηιмε⭐👈\n\n™By https://line.me/R/ti/p/%40kyx3655e")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like by ⭐sεℓғвσт вү-sρεcιαℓ αηιмε⭐👈\n\n™By https://line.me/R/ti/p/%40kyx3655e")
                    ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId']," ✰sεℓғвσт вү-sρεcιαℓ αηιмε✰")
                    print "Like"
                except:
                    pass
            else:
                print "Status Sudah di Like Pak"
